    ...
    $('form#form').submit(function () {
        ...
        if (!hasError) {
            ...
            $.post($(this).attr('action'), formInput, function (data) {
                    $('form#form').append('<div class="success"><div class="col-md-12"><div class="alert alert-nesto"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><p>'+data+'</p></div></div></div>');
            });
            $('.requiredField').val('');
        }
        return false;
